...
|---------------------|---------------------|--------------|
| **Trabaja en equipo para proporcionar liderazgo en forma conjunta** | **TB1**<br>- Antayhua Castillo, Oscar Josué:<br>Participé activamente en las reuniones de equipo, completé mi parte del trabajo dentro de los plazos establecidos, colaboré en la revisión del código de mis compañeros y proporcioné retroalimentación constructiva.<br>-Eddo Su Caletti: Participe en todas las reuniones del equipo  y tambien complete todas mis partes del trabajo que me han encomendado y enviados antes de las fechas dadas y, ademas, hice retroalimentación en algunas partes del trabajo .<br>-Diego Ivan Cabrera Buitron: Participé activamente en la realización del presente proyecto, asistiendo a la reuniones y colaborando grupalmente con mis compañeros. <br>-Juan Paul Llamccaya Arone: Participé en cada una de las reuniones de coordinación, propuse mejoras en las historias de usuario, organicé y documenté parte del Product Backlog, colaboré en el diseño y ejecución de entrevistas, y brindé apoyo a mis compañeros durante la planificación general del proyecto. | **TB1**<br>Se trabajó en equipo tanto en nuestras sesiones presenciales como en nuestras reuniones remotas, proporcionamos conjuntamente un liderazgo de equipo integro para elaborar de nuestro producto y el desarrollo profesional de cada miembro del equipo. |
| **Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos** | **TB1**<br>- Antayhua Castillo, Oscar Josué:<br>Asistencia a reuniones de equipo, apertura de ayuda a otros miembros del equipo y cumplimiento de la creación estructural de la carátula, registro de versiones, project report collaborations insights, contenido del informe y el student outcome.<br>-Eddo Su Caletti: Asistencia en todas las llamadas grupales, ayuda a otros mienbros del equipo me encargue del impac map, tambien en la creacion de los wireframes y mock up, tambien de la web apications user flow diagrams y contenido del informe y el student outcome. <br>-Diego Ivan Cabrera Buitron: Asistí a todas las reuniones y brindé retroalimentación sobre el avance del proyecto, apoyé y participé en la creación de los User Persona, Empathy Mapping y As Is Mapping.  <br>-Juan Paul Llamccaya Arone: Colaboré en la organización de tareas y tiempos de entrega, coordiné entrevistas y ayudé en su documentación, propuse mejoras en el backlog y la redacción de user stories, y participé activamente en la redacción del informe del proyecto. Mi aporte se centró en el diseño y registro de entrevistas, la creación de user personas, el desarrollo de historias de usuario y la elaboración del product backlog.| **TB1**<br>Cada miembro de nuestro equipo mostró disposición y estableció un entorno colaborativo a través de medios de comunicación efectivos, se establecieron reuniones, llamadas, entregas tempranas y constantes revisiones de cada capítulo de nuestro proyecto. Nos reunimos en periodos continuos para opinar y colaborar en cada proceso del desarrollo de nuestro producto y su documentación. Nos establecimos metas tempranas con la planificación de tareas y las mejoramos conjuntamente con la revisión de la calidad del proceso culminado. |
